  ...
  return (
    <section className='container mx-auto flex items-center lg:justify-around h-[90vh] gap-5'>
        <div className="open lg:w-[30%] flex flex-col items-center lg:items-start gap-3">
            <h2 className='font-semibold text-3xl text-[#5F5F5F] text-center lg:text-left'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed gravida ipsum eget</h2>
            <p className='text-[#5F5F5F] text-center lg:text-left'>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed gravida ipsum eget</p>
